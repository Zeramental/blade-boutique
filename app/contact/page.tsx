...
export const metadata: Metadata = {
  title: "Contact Blade Boutique: Visit, Call or WhatsApp (Fourways, Johannesburg)",
  description: `Visit Blade Boutique at ${STUDIO.fullAddress}. WhatsApp Sam on ${STUDIO.phoneDisplay} or browse studio hours. Permanent makeup studio serving Fourways, Johannesburg and Pretoria.`,
    ...
    <>
      ...
      <div className="bb-container py-16 md:py-24">
        ...
        <p className="bb-body-lg max-w-[58ch] mb-16">
          The studio is inside Rustic Timber & Garden Centre in Fourways, Johannesburg.
